  ...
  return (
    <div className="BookManagerContainer">
      <div className="ManageBooks">
        ...
        />
        <BottomBar buttonName="Insert" />
      </div>
    </div>
  );
};

function InsertBookEntry(props) {
...
function InsertBookTableHeader() {
  return (
...
function InsertBookTableBottom() {
  return (
    <div className="table-heading">
...
export default InsertBookManager;

function InsertEntryMainForm({ value, onChange, toggleCategory }) {
  return (
...
function InsertEntryCategoryForm({ categories, showCategory }) {
  return (
    <div
...
function InsertBooksTable({ categories, entries, handleInputChange }) {
  return (
